...
export function createOrderStatusTool(config: OrderStatusToolConfig = {}) {
  ...
  return async function orderStatus(args: {
    ...
    const readResult = await readGwsValuesWithRetries({
      ...
      retryBackoffMs,
      runner: gwsRunner,
      errorPrefix: "order_status_gws",
      invalidPayloadError: "order_status_gws_invalid_payload",
      commandUnavailableError: "order_status_gws_command_unavailable",
      failedError: "order_status_failed",
