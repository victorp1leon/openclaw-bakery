...
- `intent-scope-collision-guard.md`: guard obligatorio para intents hermanos por alcance temporal (`day|week|month|year`) y sus flujos de aclaracion.
...
- `code-review-graph-impact-gate.md`: gate operativo CRG (build/impact/context) para cambios elegibles when-enabled, con evidencia minima y escalamiento por impacto.
