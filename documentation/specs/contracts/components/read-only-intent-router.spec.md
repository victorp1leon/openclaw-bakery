...
`admin.health`, `admin.config.view`, `report.orders`, `report.reminders`, `order.lookup`, `order.status`, `schedule.day_view`, `schedule.week_view`, `shopping.list.generate`, `quote.order`.
