...
- shopping list query responses (`insumos/surtido`) via read-only adapter
...
5. For report/lookup/status/shopping-list read-only queries, it resolves adapter paths without confirmation flow.
